    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen px-4 py-10 bg-gray-100">
            <div className="max-w-3xl bg-white shadow-md rounded-lg p-8">
                ...
                <h2 className="text-2xl font-semibold mt-6 mb-4 text-black">1. Acceptance of Terms</h2>
                <p className="text-gray-700 leading-relaxed">
                    By accessing or using our website, you agree to be bound by these terms. If you do not
                    agree, please do not use our services.
                </p>

                <h2 className="text-2xl font-semibold mt-6 mb-4 text-black">2. Use of Services</h2>
                <p className="text-gray-700 leading-relaxed">
                ...
                <h2 className="text-2xl font-semibold mt-6 mb-4 text-black">3. Intellectual Property</h2>
                <p className="text-gray-700 leading-relaxed">
                ...
                <h2 className="text-2xl font-semibold mt-6 mb-4 text-black">4. Limitation of Liability</h2>
                <p className="text-gray-700 leading-relaxed">
                ...
                <h2 className="text-2xl font-semibold mt-6 mb-4 text-black">5. Modifications to Terms</h2>
                <p className="text-gray-700 leading-relaxed">
